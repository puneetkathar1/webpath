...
const ToastReel = ({ data }) => {
  ...
  return (
    <React.Fragment>
          ...
          {(ref) => (
            <>
              <p className="mt-20" ref={ref}>
                We are thrilled to share our new reel with you all! Special
                thanks to all of our talented friends we've had the pleasure of
                working with over the past year. We're excited to see what the
                next year brings!
              </p>
      ...
      />
      <ParallaxImage
        src="/assets/img/project/project4/3.jpg"
        caption="Caption #2"
        triggerHook="top"
        animationActive={false}
      />
      <ParallaxImage
        src="/assets/img/project/project4/4.jpg"
        caption="Caption #3"
        triggerHook="top"
        animationActive={false}
      />
      <ParallaxImage
        src="/assets/img/project/project4/5.jpg"
        caption="Caption #4"
        triggerHook="top"
        animationActive={false}
      />
      <ParallaxImage
        ...
        src="/assets/img/project/project4/6.jpg"
        caption="Caption #5"
        triggerHook="top"
        animationActive={false}
        parallax={{ scale: 1 }}
