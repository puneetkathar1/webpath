  ...
  return (
    <React.Fragment>
          ...
          {(ref) => (
            <>
              <p className="mt-20" ref={ref}>
                ...
                California. They are the pioneers. They are the trailblazers who
                started it all. Same goes for Under Armour. When status quo was
                the status quo, they changed everything. Starting revolutions.
                Challenging authority. Being first. Thatu2019s what Cal and
                Under Armour have been doing since their respective day ones.
                Now, together, through passion, design, and the relentless
                pursuit of innovation, they fight to keep that revolutionary
                spirit alive.
              </p>
              <ul className="mt-20 color-heading">
                <li ref={ref}>Art Direction: Kirk Roush</li>
                <li className="mt-1" ref={ref}>
                  Photography: Sam Gordon
                </li>
                <li className="mt-1" ref={ref}>
      ...
      <BoxGallery
        ...
        images={[
          {
            src: "/assets/img/project/project2/3.jpg",
            caption: "Trevor Bittinger",
          },
          {
            src: "/assets/img/project/project2/4.jpg",
            caption: "Sef McCullough",
          },
          {
            src: "/assets/img/project/project2/5.jpg",
            caption: "Sef McCullough",
          },
        ]}
      />
