  ...
  return (
    <React.Fragment>
      ...
      <Container className="section-margin">
        ...
        <FadeUpTrigger>
          <p className="mt-20">
            Bastian bux is the consequence of reducing everything surrounding a
            dj and producer to its essential element: the music. that is the
            intention of bux: be stripped of all artifice and be judged by his
            work. Pieces full of deep textures, powerful harmonies, heavy beats
            and fat basslines; where everything is assembled with soul and
            sensibility.
          </p>
          <ButtonProject
            className="mt-20"
      ...
      <ParallaxImage
        ...
        src="/assets/img/project/project9/2.jpg"
        height={"80vh"}
        caption="Caption #1"
      />
      ...
      <ParallaxImage
        className="section-margin"
        src="/assets/img/project/project9/4.gif"
        caption="Caption #5"
        triggerHook="top"
        parallax={{ scale: 1 }}
