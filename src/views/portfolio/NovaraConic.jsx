...
const NovaraConic = ({ data }) => {
  ...
  return (
    <React.Fragment>
      ...
      <Container className="section-margin">
        ...
        <FadeUpTrigger>
          <p className="mt-20">
            ...
            started it all. Same goes for Under Armour. When status quo was the
            status quo, they changed everything. Starting revolutions.
            Challenging authority. Being first. Thatu2019s what Cal and Under
            Armour have been doing since their respective day ones. Now,
            together, through passion, design, and the relentless pursuit of
      ...
      <BoxImageVertical
        src="/assets/img/project/project8/5.jpg"
      ...
      <ParallaxImage
        ...
        src="/assets/img/project/project8/6.jpg"
        caption="Caption #5"
        triggerHook="top"
        parallax={{ scale: 1 }}
