  ...
  return (
    <React.Fragment>
      ...
      <Container className="section-margin">
        ...
        <FadeUpTrigger>
          <p className="mt-20">
            Once the brand strategy was sharp and real for everyone inside of
            the company, all the brand behavior started to roll out as
            stationary material, social media efforts, office ambiance, and
            internal communication, modernizing its interface with clients,
            prospects, suppliers and the creative industry in general.
          </p>
          <ButtonProject
            className="mt-20"
            href="https://www.behance.net/gallery/82911685/Re-Styling-for-Neorama?tracking_source=projectScroller"
        ...
        <TextTrigger duration={0.5} stagger={0.1}>
          {(ref) => (
            <h5 className="m-w750 dsn-auto" ref={ref}>
              New projects, new people, greater goals. So they reached us to
              help them expand their ability to communicate with their
              stakeholders and to refresh their identity system
            </h5>
          )}
        </TextTrigger>
      </Container>
